...
$(document).ready(function () {
    //get columns names
    var my_cols = function(){
        var tmp = null
        $.ajax({
            type: "GET",
            url: RESTFUL_HOST + RESTFUL_GRID_COLUMN_NAMES,
            dataType: "json",
...
var col_names = ['Edit Actions','編號','年度','年級','課次','生字','生字注音','部首','部首注音','總筆畫','部首外筆畫','字義教學','造詞教學-造詞','造詞教學1','造詞教學2','成語教學','字形辨別','字音辨別','教學圖卡'];
